...
model = TransMIL_LinearPE(cD, PE = True).to(device)
...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), '/data2/meerak/models/best_transmil_LINEARPE_mimiccxr_densenet_epoch%d'%(epoch))
    ...
    with open('best_transmil_LINEARPE.txt', 'w') as f:
        count = 0
