...
# K:4, Drop:0, cC:0.7, LR:1e-5, WD:1e-6
cK = 4
cDrop = 0 
cC = 0.7
cLR = 1e-5
...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), '/data2/meerak/models/best_clamMB_pe_mimiccxr_densenet_epoch%d'%(epoch))
    ...
    with open('best_clamMB_pe.txt', 'w') as f:
        count = 0
