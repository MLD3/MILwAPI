...
#K:8, Drop:0, cC:0.7, LR:1e-5, WD:1e-7
cK = 8
cDrop = 0 
cC = 0.7
cLR = 1e-5
...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), '../models/best_clamMB_nope_mimiccxr_densenet_epoch%d'%(epoch))
    ...
    with open('best_clamMB_nope.txt', 'w') as f:
        count = 0
