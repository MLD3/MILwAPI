...
from models_transmil_orig_nope import *
import numpy as np
import random
...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), '/data2/user/models/best_transmil_orig_nope_mimiccxr_densenet_epoch%d'%(epoch))
    ...
    with open('best_transmil_orig_nope.txt', 'w') as f:
        count = 0
