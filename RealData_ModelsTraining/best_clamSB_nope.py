...
#K:6, Drop:0, cC:0.5, LR:1e-5, WD:1e-7
cK = 6
cDrop = 0 
cC = 0.5
cLR = 1e-5
...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), '/data2/meerak/models/best_clamSB_nope_mimiccxr_densenet_epoch%d'%(epoch))
    ...
    with open('best_clamSB_nope.txt', 'w') as f:
        count = 0
