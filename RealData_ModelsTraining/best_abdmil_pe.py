...
for epoch in range(100):
    ...
    torch.save(model.state_dict(), '/data2/meerak/models/best_abdmil_pe_mimiccxr_densenet_epoch%d'%(epoch))
    ...
    with open('best_abdmil_pe.txt', 'w') as f:
        count = 0
