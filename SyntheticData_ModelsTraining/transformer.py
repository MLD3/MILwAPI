    ...
    for perm_dist in range(9, 11):
        ...
        for seed in range(10):
            ...
            for epoch in range(500):
                ...
                with open('../txtfiles/seed%d_numbags%d_MNIST_permdist%d_transformer_loss.txt'%(seed, num_bags, perm_dist), 'w') as f:
                    count = -1
