        ...
        for seed in range(10):
            ...
            for epoch in range(500):
                ...
                for curridx, x_i, y_i, actual_y_i in train_loader:
                    ...
                    loss_bag = criterion(bag_prediction, y_i.long())
                ...
                with open('/data2/meerak/txtfiles/seed%d_numbags%d_MNIST_permdist%d_DAS_transformer_loss.txt'%(seed, num_bags, perm_dist), 'w') as f:
                    count = -1
