        ...
        for seed in range(10):
            ...
            for epoch in range(500):
                ...
                for curridx, x_i, y_i, actual_y_i in train_loader:
                    ...
                    loss_bag, loss_inst = sgl(inst_pred, y_i.long(), delta = 0.3, pool_before_act = 1)

                    final_loss = loss_bag + loss_inst
                ...
                with open('/data2/meerak/txtfiles/seed%d_numbags%d_MNIST_permdist%d_sglmodel_pe_loss.txt'%(seed, num_bags, perm_dist), 'w') as f:
                    count = -1
